            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-blue-600 mb-2">언어치료</h4>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-blue-600 mb-2">놀이치료</h4>
                    <p className="text-xs text-gray-500 mb-2">
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-blue-600 mb-2">감각통합치료</h4>
                    <p className="text-sm text-gray-700 mb-2">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-blue-600 mb-2">작업치료</h4>
                    <p className="text-sm text-gray-700 mb-2">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-blue-600 mb-2">물리(운동)치료</h4>
                    <p className="text-sm text-gray-700 mb-2">
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-blue-600 mb-2">인지학습치료</h4>
                    <p className="text-sm text-gray-700 mb-2">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-blue-600 mb-2">ABA 치료</h4>
                    <p className="text-sm text-gray-700 mb-2">
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-blue-600 mb-2">미술치료 & 음악치료</h4>
                    <p className="text-sm text-gray-700 mb-2">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-blue-600 mb-2">특수체육</h4>
                    <p className="text-sm text-gray-700 mb-2">
            ...
            <div className="mb-8">
              ...
              <div className="grid md:grid-cols-1 gap-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-blue-600 mb-2">특수교사 & 임상심리 & 모니터링</h4>
                    <p className="text-sm text-gray-700">
