          ...
          <div className="flex-1">
            ...
            <div className="mb-12">
              ...
              <div className="mb-4">
                ...
                <ul className="list-disc list-inside ml-4 space-y-1 text-xs text-gray-700">
                  <li><span className="text-blue-700 font-semibold">[선생님께 요청하기]</span>에 원하는 홈티 조건을 게시하여 선생님들의 지원을 받습니다.</li>
            ...
            <div className="mb-12">
              ...
              <p className="text-sm text-gray-700">
                첫 달 수업 완료 후, 선생님과 직접 소통하며 편리한 후불제(개인 계좌 이체)로 정산합니다. 이후 과정에 <span className="text-blue-700 font-semibold">모든별 키즈</span>는 수수료를 부과하지 않습니다.
              </p>
              {/* STEP 3 내용 아래 구분선 */}
              <div className="border-t border-gray-300 mt-6"></div>
            </div>
