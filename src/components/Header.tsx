        ...
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex space-x-10">
            ...
            >
              ...
              {/* 드롭다운 메뉴 */}
              <div className={`absolute top-full left-0 mt-1 w-48 bg-white rounded-md shadow-lg border border-gray-200 z-50 transition-all duration-200 ${
                isGuideDropdownOpen 
                  ...
                  : 'opacity-0 -translate-y-2 invisible'
                                ...
                                <Link 
                  href="/parent-guide" 
                  className="block px-4 py-3 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-500 transition-colors first:rounded-t-md"
                >
                  학부모 이용안내
                </Link>
                <Link 
                ...
                <Link 
                  href="/pricing" 
                  className="block px-4 py-3 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-500 transition-colors last:rounded-b-md"
                >
                  이용권 구매
                </Link>
              </div>
              ...
              <div className={`absolute top-full left-0 mt-1 w-48 bg-white rounded-md shadow-lg border border-gray-200 z-50 transition-all duration-200 ${
                isCommunityDropdownOpen 
                  ...
                  : 'opacity-0 -translate-y-2 invisible'
                                ...
                                <Link 
                  href="/reviews" 
                  className="block px-4 py-3 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-500 transition-colors rounded-md"
                >
                  후기 작성/보기
                </Link>
              </div>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-gray-200">
              ...
              <div>
                ...
                <div className={`pl-6 space-y-1 transition-all duration-200 overflow-hidden ${
                  ...
                  <Link 
                    href="/parent-guide" 
                    className="text-gray-600 hover:text-blue-500 block px-3 py-2 rounded-md text-sm transition-colors"
                    onClick={() => {
                      setIsMenuOpen(false);
