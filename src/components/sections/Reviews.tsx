...
export default function Reviews() {
  ...
  const reviews = [
    ...
    },
    {
      ...
      content: "7세 딸의 분리불안 때문에 어린이집도 못 보냈는데, 박소영 선생님의 놀이치료 덕분에 점점 독립적으로 변하고 있습니다. 아이의 마음을 정말 잘 이해해주시는 전문가입니다. 더모든 키즈를 통해 만난 최고의 선생님이에요!",
      rating: 5,
      author: "이수진 학부모", 
      program: "놀이치료",
      date: "2024.01.18"
    ...
    },
    {
      ...
      content: "자존감이 낮고 내성적이었던 6세 딸이 한수진 선생님의 미술치료를 받으면서 완전히 달라졌습니다. 그림을 통해 감정 표현법을 배우고 자신감도 생겼어요. 더모든 키즈의 검증된 전문가 시스템 덕분에 믿고 맡길 수 있었습니다.",
      rating: 5,
      author: "윤정희 학부모",
      program: "미술치료",
      date: "2024.01.10"
